...
* `golfe_results` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `golfe-results` - executable or bundle name on disk.
* `golfe-results` - display name shown in window titles and about app dialogs.
